...
static const char col_violet[]      = "#474973";
static const char col_light[]       = "#fafafa";

static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_light, col_gray1, col_gray2 },
	[SchemeSel]  = { col_light, col_violet,  col_violet  },
};

/* tagging */
static const char *tags[] = { "᮱", "᮲", "᮳", "᮴", "᮵", "᮶", "᮷", "᮸", "᮹" };
